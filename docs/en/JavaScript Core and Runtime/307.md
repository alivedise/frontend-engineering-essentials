...
**Prefer named exports over default exports for tree-shaking.** SHOULD use named exports in library and shared utility code because bundlers can identify and eliminate individual unused exports. A default export exports the entire module object as a single binding, making it harder for bundlers to prove which parts are unused. AVOID mixing default and named exports in the same module, as this creates inconsistent import syntax for consumers and complicates refactoring.
