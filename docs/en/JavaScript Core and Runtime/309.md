...
- [MDN: Private class fields](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes/Private_elements) -- the modern alternative to `WeakMap`-based private data, with syntax, browser support table, and comparison with the `WeakMap` pattern
...
- [MDN: JavaScript memory management](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Memory_management) -- overview of reference counting and mark-and-sweep GC, the lifecycle of reachable objects, and common memory leak patterns in JavaScript applications
