...
Linting is automated code review. A lint rule that fires on every save catches a class of bugs more reliably than any PR review process, because it runs on every line every time and never has a bad day.
