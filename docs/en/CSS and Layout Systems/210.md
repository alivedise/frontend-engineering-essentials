...
- MDN Contributors, "backdrop-filter," MDN Web Docs (2025). https://developer.mozilla.org/en-US/docs/Web/CSS/backdrop-filter
- MDN Contributors, "mix-blend-mode," MDN Web Docs (2025). https://developer.mozilla.org/en-US/docs/Web/CSS/mix-blend-mode
- MDN Contributors, "filter," MDN Web Docs (2025). https://developer.mozilla.org/en-US/docs/Web/CSS/filter
