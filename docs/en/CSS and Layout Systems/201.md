...
- [MDN: Introducing the CSS Cascade](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Cascade/Introduction) -- Comprehensive guide to the cascade algorithm with interactive examples
- [MDN: Specificity](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Cascade/Specificity) -- Detailed specificity calculation rules, examples, and special cases
- [MDN: @layer](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/At-rules/@layer) -- Reference for cascade layer syntax, ordering, and browser support
