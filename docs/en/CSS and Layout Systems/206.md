...
- [Tailwind CSS Documentation -- Core Concepts: Utility-First Fundamentals](https://tailwindcss.com/docs/styling-with-utility-classes) -- Official documentation explaining the utility-first philosophy, responsive design, hover/focus states, and why Tailwind avoids component classes
