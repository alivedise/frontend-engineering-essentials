...
- MDN contributors, "CSS Flexible Box Layout," MDN Web Docs (2025). https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Flexible_box_layout
- MDN contributors, "CSS Grid Layout," MDN Web Docs (2025). https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Grid_layout
...
- Chris House, "A Complete Guide to CSS Grid," CSS-Tricks (2016, kept updated). https://css-tricks.com/complete-guide-css-grid-layout/
