...
- [MDN: Constraint Validation](https://developer.mozilla.org/en-US/docs/Web/HTML/Guides/Constraint_validation) -- Reference for HTML validation attributes and the Constraint Validation API
...
- [MDN: :user-valid](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Selectors/:user-valid) -- Reference for the :user-valid pseudo-class that matches after user interaction
