...
- [MDN: The `<meta>` element](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/meta) -- Reference for all meta element attributes and standard metadata names
