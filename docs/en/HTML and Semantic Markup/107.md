...
- [Next.js Docs: JSON-LD](https://nextjs.org/docs/app/getting-started/metadata-and-og-images#json-ld) — Next.js App Router pattern for embedding JSON-LD in server-rendered pages using `dangerouslySetInnerHTML`
