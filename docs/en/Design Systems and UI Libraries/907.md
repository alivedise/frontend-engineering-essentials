...
- [lucide-react Documentation](https://lucide.dev/guide/react) — Official docs for `lucide-react`, including installation, props reference, and tree-shaking notes.
...
- [MDN: aria-hidden](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-hidden) — When and how to use `aria-hidden` to remove elements from the accessibility tree.
- [MDN: aria-label](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Attributes/aria-label) — How `aria-label` provides accessible names for interactive elements without visible text.
