...
level: senior
slug: multi-brand-design-systems
reviewed: tone
...
Multiple class names, by contrast, can coexist, making it possible to
accidentally apply two brands' token blocks simultaneously and produce
unpredictable specificity resolution. Attribute selectors also interact cleanly with
...
tokens apply everywhere outside the widget.
