...
**SHOULD set sampling rates proportional to traffic volume: 1–2% for sites above 1 million daily sessions, 5–10% for 100K–1M sessions, and 100% for sites below 100K sessions.** At high traffic volumes, 1% sampling provides statistically sufficient data for tight p75 estimates. Teams MUST make sampling decisions per session so all metrics from a sampled session are reported together.
