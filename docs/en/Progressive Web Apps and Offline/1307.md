...
- Google Chrome Developers — [Lighthouse PWA audit documentation](https://developer.chrome.com/docs/lighthouse/pwa/load-fast-enough-for-pwa)
...
- Apple Developer — [Enabling the Web Push API on Apple platforms](https://developer.apple.com/documentation/usernotifications/sending-web-push-notifications-in-web-apps-and-browsers)
