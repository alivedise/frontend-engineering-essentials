...
- [MDN: Event reference](https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model/Events) -- Complete listing of all DOM events grouped by category
...
- [MDN: Creating and triggering events](https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model/Events) -- Guide to CustomEvent, dispatchEvent, and the detail property
