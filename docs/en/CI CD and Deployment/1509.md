...
- Vercel, "Performing an Instant Rollback on a Deployment," Vercel docs (2026). https://vercel.com/docs/instant-rollback
- Netlify, "Manage deploys," Netlify docs (2026). https://docs.netlify.com/deploy/manage-deploys/manage-deploys-overview/#rollbacks
