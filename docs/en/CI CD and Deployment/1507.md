...
- [Publishing Node.js packages — GitHub Docs](https://docs.github.com/en/actions/tutorials/publish-packages/publish-nodejs-packages): official GitHub documentation for npm publish from GitHub Actions, including `NODE_AUTH_TOKEN`, `registry-url`, and GitHub Packages configuration
