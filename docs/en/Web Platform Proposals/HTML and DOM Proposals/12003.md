...
- MDN Contributors, "The `<script type=speculationrules>` element," MDN Web Docs (2026). https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/script/type/speculationrules
