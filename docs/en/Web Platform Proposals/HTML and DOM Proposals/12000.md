...
- [Interop Project](https://wpt.fyi/interop-2026) — cross-vendor yearly commitment on feature compatibility; often includes HTML and DOM features on the focus list.
...
- [W3C TAG security-questionnaire](https://github.com/w3c/security-questionnaire) — the checklist used for security and privacy review of web platform proposals.
