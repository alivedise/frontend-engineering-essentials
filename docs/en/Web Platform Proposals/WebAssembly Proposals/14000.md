...
- [Spin](https://github.com/fermyon/spin) — a developer-facing Component Model runtime from Fermyon.
...
- [Apple WebKit WebAssembly](https://webkit.org/blog/search/webassembly/) — WebKit blog entries on WebAssembly progress in Safari.
...
- [Shopify Functions](https://shopify.dev/docs/apps/functions) — Shopify's WASM-based extensibility framework using the Component Model.
