...
level: senior
slug: accessibility-internationalization-intersection
reviewed: tone
...
direction check. The shift to logical properties prevents entire classes of RTL layout bugs that
result from hardcoded left/right offsets being applied in a layout where the reading direction has
been reversed.
