...
- **EAA (European Accessibility Act)** — Became enforceable across all EU member states on 28 June 2025. Applies to organizations with 10+ employees and over €2 million turnover that sell products or services to EU consumers. Covered categories include e-commerce, banking, transportation ticketing, and telecommunications.
...
The following diagram maps the four POUR principles to the WCAG conformance levels, and then shows how the FEE-1000 category entry connects to the seven sub-topics in this series.
