...
/* Gray text on white — 2.0:1 — fails AA for all text sizes */
.muted-fail {
  color: #aaaaaa;
...
/* White text on dark blue — 7.0:1 — passes AA and AAA */
.badge-pass-aaa {
  color: #ffffff;
  background-color: #003d80;
}

/* Dark gray text on white — 12.6:1 — passes AA and AAA */
.body-text-pass {
  color: #222222;
  background-color: #ffffff;
}

/* Dark text on yellow — 4.5:1 — passes AA for normal text */
.warning-badge-pass {
  color: #3d3000;
