...
4. **Apple Developer — Accessibility on iOS (VoiceOver)** — https://developer.apple.com/documentation/accessibility
...
5. **NVDA User Guide** — https://download.nvaccess.org/documentation/userGuide.html
