...
- [React Hook Form: Controller API](https://react-hook-form.com/docs/usecontroller/controller) — 展示受控介面如何包裝非受控元件
- [TkDodo: Avoiding useEffect for Data Transformation](https://tkdodo.eu/blog/avoiding-use-effect-for-data-transformation) — 延伸閱讀，說明為何不應以 useEffect 同步 state
