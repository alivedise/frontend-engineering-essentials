...
- uses: actions/setup-node@v4
  with:
    node-version: 20
    registry-url: 'https://github.com/features/actions'
    scope: '@myorg'
...
- [發布 Node.js 套件 — GitHub Docs](https://docs.github.com/en/actions/tutorials/publish-packages/publish-nodejs-packages)：從 GitHub Actions 執行 npm publish 的官方 GitHub 文件，包括 `NODE_AUTH_TOKEN`、`registry-url` 和 GitHub Packages 設定
