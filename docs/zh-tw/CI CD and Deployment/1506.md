...
- [Encrypted secrets — GitHub Docs](https://docs.github.com/en/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets)：GitHub Actions 中 repository、environment 和 organization secrets 的官方文件，包含存取控制和遮蔽行為
- [Configuring OpenID Connect in Amazon Web Services — GitHub Docs](https://docs.github.com/en/actions/how-tos/secure-your-work/security-harden-deployments/oidc-in-aws)：設定 GitHub Actions 與 AWS IAM 之間 OIDC 信任的逐步指南，包含信任政策 JSON 和 workflow 設定
- [Security hardening for GitHub Actions — GitHub Docs](https://docs.github.com/en/actions/reference/security/secure-use)：涵蓋 OIDC、secret 處理、第三方 action 固定版本和 runner 安全性的綜合指南
...
- [About secret scanning — GitHub Docs](https://docs.github.com/en/code-security/concepts/secret-security/secret-scanning)：GitHub 自動 secret scanning 的說明，包含支援的憑證格式、push protection 和通知行為
