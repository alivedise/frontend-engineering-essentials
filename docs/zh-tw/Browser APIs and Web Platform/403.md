...
- [TanStack Query Documentation](https://tanstack.com/query/latest/docs/framework/react/overview) -- 框架無關的資料擷取與 stale-while-revalidate 快取
- [MDN: AbortController](https://developer.mozilla.org/en-US/docs/Web/API/AbortController) -- 透過 AbortSignal 取消 fetch 與串流讀取
- [MDN: Request.clone()](https://developer.mozilla.org/en-US/docs/Web/API/Request/clone) -- 複製 Request 與 Response 以便多次讀取主體
- [HTTP Semantics (RFC 9110)](https://www.rfc-editor.org/info/rfc9110/) -- HTTP 方法、標頭與狀態碼的權威參考
- [MDN: Response.body](https://developer.mozilla.org/en-US/docs/Web/API/Response/body) -- Response 上的 ReadableStream 屬性，用於逐步消耗回應內容
