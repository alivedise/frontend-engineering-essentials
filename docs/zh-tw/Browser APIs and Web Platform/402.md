...
- [MDN: Event reference](https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model/Events) -- 依分類整理的完整 DOM 事件列表
...
- [MDN: Creating and triggering events](https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model/Events) -- CustomEvent、dispatchEvent 與 detail 屬性的指南
