...
Webpack 對於需要 Module Federation、依賴沒有 Vite 等效方案的 loader，或是有大量現有 Webpack 設定而遷移成本過高的專案，依然是合適的選擇。對於其他所有新的全新應用程式，團隊 SHOULD 預設選擇 Vite——其原生 ESM 開發伺服器在啟動速度和 HMR 上提供了顯著的提升，且在生產環境沒有明顯的取捨。
