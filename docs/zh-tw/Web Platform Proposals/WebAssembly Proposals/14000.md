...
- [Spin](https://github.com/spinframework/spin) — 來自 Fermyon 的開發者面向 Component Model 執行環境。
...
- [Apple WebKit WebAssembly](https://webkit.org/blog/7691/webassembly/) — WebKit 部落格關於 Safari 中 WebAssembly 進度的條目。
...
- [Shopify Functions](https://shopify.dev/docs/apps/build/functions) — Shopify 使用 Component Model 的基於 WASM 延伸性框架。
