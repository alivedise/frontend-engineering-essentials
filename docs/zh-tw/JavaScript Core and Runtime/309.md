...
- [MDN: Private class fields](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Classes/Private_elements) -- 基於 `WeakMap` 的私有資料的現代替代方案，包含語法、瀏覽器支援表，以及與 `WeakMap` 模式的比較
...
- [MDN: JavaScript 記憶體管理](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Memory_management) -- 引用計數與標記清除 GC 的總覽，可達物件的生命週期，以及 JavaScript 應用中的常見記憶體洩漏模式
