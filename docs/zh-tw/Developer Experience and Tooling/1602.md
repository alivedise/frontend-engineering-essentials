...
- [Prettier 文件](https://prettier.io/docs/)
- [Prettier：為什麼使用 Prettier？](https://prettier.io/docs/why-prettier.html)
- [Prettier：設定](https://prettier.io/docs/configuration.html)
